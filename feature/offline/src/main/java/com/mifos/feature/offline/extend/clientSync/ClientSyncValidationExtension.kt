...
fun ClientValidationScreen(
    ...
    var selectedOfficeIds by remember { mutableStateOf(invalidPayloads.map { 0 }) }
    var selectedGenderIds by remember { mutableStateOf(invalidPayloads.map { 0 }) }
    ...
    Column(
        ...
        Row(
            ...
            Button(
                onClick = {
                    ...
                    val updates =
                        invalidPayloads.mapIndexedNotNull { index, payload ->
                            ...
                            if (officeId != null || genderId != null) {
                ...
                modifier = Modifier.weight(1f),
                enabled = selectedOfficeIds.all { it > 0 } && selectedGenderIds.all { it > 0 } && !isUpdateAndSyncInProgress,
            ) {
        ...
        Column(
            ...
            if (clientTemplate?.genderOptions?.isNotEmpty() == true) {
                MifosTextFieldDropdown(
                    ...
                    label = R.string.feature_offline_gender_required,
